...
async def seed_data():
    ...
    async with SessionLocal() as db:
        ...
        default_objectives = [
            StoreActionObjective(business_id=biz_id, name="THREAT_RESPONSE", label="Competitive Response", category=ActionCategory.COMMERCIAL, description="Acción de respuesta rápida ante movimientos de competidores directos en la zona."),
            StoreActionObjective(business_id=biz_id, name="THREAT_RESPONSE", label="Competitive Response", category=ActionCategory.MARKETING, description="Acción de respuesta rápida ante movimientos de competidores directos en la zona."),
            StoreActionObjective(business_id=biz_id, name="SHARE_OF_SHELF", label="Shelf Presence Check", category=ActionCategory.MARKETING, description="Medición y auditoría de la participación en anaquel de nuestros productos."),
            StoreActionObjective(business_id=biz_id, name="NEW_PRODUCT_INTRODUCTION", label="Launch New Product", category=ActionCategory.COMMERCIAL, description="Acción para presentar o vender nuevos lanzamientos de catálogo."),
            StoreActionObjective(business_id=biz_id, name="NEW_PRODUCT_INTRODUCTION", label="Launch New Product", category=ActionCategory.MARKETING, description="Acción para presentar o vender nuevos lanzamientos de catálogo."),
            StoreActionObjective(business_id=biz_id, name="INVENTORY_VELOCITY_OOS_PREVENTION", label="Prevent Stockouts", category=ActionCategory.COMMERCIAL, description="Acción para reabastecer inventario, acelerar rotación y prevenir agotados."),
            StoreActionObjective(business_id=biz_id, name="PERFECT_STORE_ASSORTMENT_COMPLIANCE", label='Store Standards Check', category=ActionCategory.COMMERCIAL, description="Auditoría y ejecución de estándares de Tienda Perfecta y cumplimiento de portafolio."),
            StoreActionObjective(business_id=biz_id, name="PERFECT_STORE_ASSORTMENT_COMPLIANCE", label='Store Standards Check', category=ActionCategory.MARKETING, description="Auditoría y ejecución de estándares de Tienda Perfecta y cumplimiento de portafolio."),
            StoreActionObjective(business_id=biz_id, name="SEASONAL_EVENT_ACTIVATION", label="Seasonal Promotion", category=ActionCategory.MARKETING, description="Acciones promocionales especiales por temporalidad, festividades o eventos del canal."),
            StoreActionObjective(business_id=biz_id, name="TRADE_LOYALTY_VOLUME_PUSHING", label="Drive Larger Orders", category=ActionCategory.COMMERCIAL, description="Campaña de fidelización del canal de distribución y colocación de pedidos de volumen."),
            StoreActionObjective(business_id=biz_id, name="POSM_MAINTENANCE_ASSET_PURITY", label="Maintain Promo Materials", category=ActionCategory.MARKETING, description="Auditoría, mantenimiento y colocación de material publicitario (POSM) y pureza de exhibidores.")
        ]
